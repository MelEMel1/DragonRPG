...
public class SpinMe : MonoBehaviour {
	...
	void Update () {
        ...
        // degrees frame^-1 = seconds frame^-1 / seconds minute^-1 * degrees rotation^-1 * rotations mintue^-1
        // degrees frame^-1 = frame^-1 minute * degrees rotation^-1 * rotations mintue^-1
